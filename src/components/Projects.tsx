...
const projectsData = [
  ...
  },
  {
    ...
    descHe: 'אנחנו פשוט נהנים ליצור סביבה שבה הקוד ורצון הלקוח נפגשים ללא מתווכים. כשכל החלקים מסתדרים במקומם והזיוף נעלם, זה פשוט יפה.',
  ...
  },
  {
    ...
    descHe: 'מבנים הם דרך לארגן מרחב כך שאנשים לא ירצו לברוח ממנו. אנו מנסים להבין את הכללים הבסיסיים של האופן שבו קירות וחלונות משפיעים על התחושה העצמית שלנו.',
...
export function Projects() {
  ...
  // Функция для получения нужного поля в зависимости от языка
  ...
  return (
    <section
      id="projects"
      className="py-32 px-6 bg-[#0a0a0a] text-white"
    >
          ...
          {projectsData.map((project) => (
            ...
            >
              <div className="aspect-[16/10] overflow-hidden border-b border-white/5">
                <img
                  src={project.image}
                  className="w-full h-full object-cover opacity-40 grayscale group-hover:opacity-70 group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000"
